...
public class GlobalParams {
	 ...
	 */
	public static String IMG_RUNNER_BACKGROUND = "resources/runnerbck.jpg";
	...
	// * Path of 3D models
	// */
	// public static String MODEL_PLANE =
	// "resources/models/seymourplane-150-im.dae";
	//
	//
	// /**
	...
	// */
	// public static int RACE_START_DELAY_IN_MILLISECONDS = 10_000;
	//
	// /**
